...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-[240px] flex-col border-r border-zinc-800 bg-zinc-900 text-sm">
      ...
      <div className="mt-auto space-y-2 border-t border-zinc-800 p-3">
        ...
        <div className="flex items-center gap-2 px-2 py-1 text-zinc-300">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-[11px] text-zinc-500">analyst@company.com</p>
          </div>
        </div>
        <Link
